...
const answers_no = {
    english: [
    "No",
    "Leslie Chow, ¿estás segura?",
    "¿Estás realmente segura, amor?",
    ...
    "Está bien, ahora sí estás lastimando mis sentimientos",
    "Ahora solo estás siendo un poco cruel conmigo",
    "¿Por qué me haces esto?",
    "Por favor, dame una oportunidad",
    "Te estoy pidiendo que pares",
    "Está bien, mejor empecemos de nuevo"
...
no_button.addEventListener('click', () => {
    ...
    if (i < total - 1) {
        no_button.querySelector('p').textContent = answers_no[language][i];
        i++;
    } else if (i === total - 1) {
        alert(answers_no[language][i]);
        i = 1;
        no_button.querySelector('p').textContent = answers_no[language][i];
        yes_button.querySelector('p').textContent = answers_yes[language];
